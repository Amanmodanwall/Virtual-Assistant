  ...
  return (
    <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] ">
      ...
      <div className="w-full max-w-[900px] flex justify-center items-center flex-wrap gap-[15px]">
        ...
        <div
          className={`w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-[#020220] border-2 rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-950 cursor-pointer hover:border-4 hover:border-white flex items-center justify-center  ${selectedImage=="input"?"hover:border-4 border-white shadow-2xl shadow-blue-950": null}`}
